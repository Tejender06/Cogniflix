...
async function createIndexes() {
  ...
  try {
    ...
    try {
      ...
      console.log("⚠️ Could not create pg_trgm extension. This requires superuser privileges on some DBs.");
    ...
    try {
      ...
      console.log("⚠️ Could not create GIN trigram indexes. Falling back to regular B-tree indexes.");
    ...
    try {
      ...
      console.log("⚠️ HNSW index failed, falling back to ivfflat...");
