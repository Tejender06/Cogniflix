...
export default function DashboardPage() {
  ...
  const [aiTopPicks, setAiTopPicks] = useState<Movie[]>([]);
    ...
    const loadData = async () => {
      try {
        ...
        if (dashboardData) {
          ...
          setAiTopPicks(dashboardData.aiTopPicks || []);
        }
      } catch (err) {
        console.error(err);
      } finally {
  ...
  return (
    ...
    >
      ...
      <div className="dashboard-content">
        ...
        {aiTopPicks.length > 0 && <MovieRow title="✨ AI Top Picks For You" movies={aiTopPicks} />}
